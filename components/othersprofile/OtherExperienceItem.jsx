...
export default function OtherExperienceItem({ exp }) {
  return (
    <div className="p-4 rounded-lg border-l-4 border-primary/40 dark:border-accent/40
      bg-gradient-to-br from-blue-50/50 to-white/50
      dark:from-gray-800/50 dark:to-gray-900/50
      hover:shadow-md transition-all duration-300 mb-3">
